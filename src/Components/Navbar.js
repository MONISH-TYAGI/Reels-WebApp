  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="fixed" sx={{background:'white'}}> 
        <Toolbar>
          <div style={{marginLeft:'5%'}} className="mr-4">
              <img src={insta} style={{width:'20vh'}} onClick={handlebannerclick} />
          </div>
          <Box sx={{ flexGrow: 1, paddingLeft:"10%" }} />
          <Box sx={{ display: { xs: 'flex', md: 'flex' },color:{xs:"black",md:"black"} ,alignItems:'center', justifyContent:"end" }}  className="setNavbar">
            <HomeIcon onClick={handlebannerclick} sx={{marginRight:'0.5rem',cursor:"pointer"}}/>
